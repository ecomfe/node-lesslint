    ...
    parser.parse(
        ...
        function (err, tree) {
            ...
            if (err) {
                ...
                if (err.extract) {
                    errMsg += ': '
                        + chalk.grey(err.extract[1].slice(0, err.column))
                        + chalk.red(err.extract[1].slice(err.column));
                }
            ...
            try {
                ...
                if (e.extract) {
                    errMsg += ': '
                        + chalk.grey(e.extract[1].slice(0, e.column))
                        + chalk.red(e.extract[1].slice(e.column));
                }
