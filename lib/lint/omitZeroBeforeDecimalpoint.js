                    ...
                    if (zeroBeforeDecimalpointType === '1') {
                        me.invalidList.push({
                            ...
                            message: '`'
                                ...
                                + 'the same project consistent, Current file before the decimal point 0 is not omitted.',
                            colorMessage: '`'
                                + lineContent.replace(
                                    value,
                                    chalk.magenta(value)
                    ...
                    if (zeroBeforeDecimalpointType === '0') {
                        me.invalidList.push({
                            ...
                            message: '`'
                                ...
                                + '` '
                                + 'In (0, 1) numerical range, before the decimal point 0 MAY omitted, must be '
                                + 'the same project consistent, Current file before the decimal point 0 is omitted.',
                            colorMessage: '`'
                                + lineContent.replace(
                                    value,
                                    chalk.magenta(value)
