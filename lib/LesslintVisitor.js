...
function analyzeValue(value, name, unit, index, type, lesslintVisitor) {
    ...
    if (Array.isArray(value)) {
        ...
        if (value.value || value.value === 0) {
            ...
            var index = value.index || index || 0;
            // console.warn( lesslintVisitor.fileData);
            var lineNum = util.getLine(index, lesslintVisitor.fileData);
            me.realVal.name = name;
            me.realVal.unit = unit;
            me.realVal.index = value.index || index || 0;
